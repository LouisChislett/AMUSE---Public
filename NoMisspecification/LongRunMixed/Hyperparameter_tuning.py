...
# Save cumulative utilities to Outputs folder
os.makedirs("Outputs", exist_ok=True)

df.index.name = "Update Penalty"
df.columns.name = "Cost"

df.to_csv("Outputs/cumulative_utilities.csv")

print("Saved cumulative utilities to Outputs/hyperparameter_tuning_utilities.csv")
