...
class ModelUpdatingEnv(gym.Env):
    ...
    def __init__(self, datasets, update_penalty, n_timesteps):
        ...
        self.X = datasets[0].drop(columns=['class', 'date', 'day'])
        self.Y = datasets[0]['class']
    ...
    def step(self, action):
        ...
        self.X = datasets[self.current_step].drop(columns=['class', 'date', 'day'])
        self.Y = datasets[self.current_step]['class']
